...
| 2026-04-25 | [ADR-0017](0017-lru-solver-memoisation.md) | Session-level LRU memoisation for GenSOLVER constraint solver proposed |
| 2026-04-17 | [ADR-0016](0016-gstand-dose-rule-fallback.md) | G-Standard dose-rule fallback for missing adult rules proposed |
