...
let scopes = "agents|logging|nlp|ots|genunits|gensolver|gencore|zindex|zform|nkf|ftk|genform|genorder|mcp|fhir|dataplatform|hixconnect|utils|client|server|api|ui|config|deps|docker|github|deploy"
