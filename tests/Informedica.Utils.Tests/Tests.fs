...
module Tests =
            ...
            testList
                ...
                [
                    ...
                    test "splitAt split of null will yield " {
                        null |> String.splitAt ' ' |> equals [||] " empty array "
                    }

                    test "splitAt split of an empty string will yield " {
                        "" |> String.splitAt 'a' |> equals [| "" |] "an array with an empty string"
                    }
                    ...
                    test "split with a null will yield" { null |> String.split "" |> equals [] "an empty list" }

                    test "capitalize of an empty string" {
                        "" |> String.capitalize |> equals "" "returns an empty string"
                    }

                    test "capitalize of an null string" {
                        null |> String.capitalize |> equals "" "returns an empty string"
                    }
                    ...
                    test "contains null string null string" {
                        null |> String.contains null |> equals false "returns false"
                    }

                    test "contains empty string null string" {
                        "" |> String.contains null |> equals false "returns false"
                    }

                    test "contains null string empty string" {
                        null |> String.contains "" |> equals false "returns false"
                    }

                    test "contains abc string null string" {
                        "abc" |> String.contains null |> equals false "returns false"
                    }

                    test "contains abc string empty string" {
                        "abc" |> String.contains "" |> equals true "returns true"
                    }

                    test "contains abc string a string" { "abc" |> String.contains "a" |> equals true "returns true" }

                    test "contains abc string b string" { "abc" |> String.contains "b" |> equals true "returns true" }

                    test "contains abc string c string" { "abc" |> String.contains "c" |> equals true "returns true" }

                    test "contains abc string abcd string" {
                        "abc" |> String.contains "abcd" |> equals false "returns false"
                    }

                    test "equals null string null string" { null |> String.equals null |> equals true "returns true" }

                    test "equals null string empty string" { null |> String.equals "" |> equals false "returns false" }

                    test "equals a string A string" { "a" |> String.equals "A" |> equals false "returns false" }

                    test "equalsCapsInsens a string A string" {
                        "a" |> String.equalsCapInsens "A" |> equals true "returns true"
                    }

                    test "subString of a null string will yield" {
                        null |> String.subString 0 1 |> equals "" "returns an empty string"
                    }

                    test "subString of an empty string will yield" {
                        "" |> String.subString 0 1 |> equals "" "returns an empty string"
                    }

                    test "subString 0 1 of abc string will yield" {
                        "abc" |> String.subString 0 1 |> equals "a" "returns a"
                    }

                    test "subString 1 1 of abc string will yield" {
                        "abc" |> String.subString 1 1 |> equals "b" "returns b"
                    }

                    test "subString 0 0 of abc string will yield" {
                        "abc" |> String.subString 0 0 |> equals "" "returns an empty string"
                    }

                    test "subString 1 -1 of abc string will yield" {
                        "abc" |> String.subString 1 -1 |> equals "a" "returns an a"
                    }

                    test "subString 1 -2 of abc string will yield" {
                        "abc" |> String.subString 1 -2 |> equals "" "returns an empty string"
                    }

                    test "startsWith null string with null string" {
                        null |> String.startsWith null |> equals false "returns false"
                    }

                    test "startsWith null string with empty string" {
                        null |> String.startsWith "" |> equals false "returns false"
                    }

                    test "startsWith empty string with null string" {
                        "" |> String.startsWith null |> equals false "returns false"
                    }

                    test "startsWith abc string with a string" {
                        "abc" |> String.startsWith "a" |> equals true "returns true"
                    }

                    test "startsWith abc string with abc string" {
                        "abc" |> String.startsWith "abc" |> equals true "returns true"
                    }

                    test "startsWith abc string with abcd string" {
                        "abc" |> String.startsWith "abcd" |> equals false "returns false"
                    }

                    test "startsWith abc string with A string" {
                        "abc" |> String.startsWith "A" |> equals false "returns false"
                    }

                    test "startsWithCapsInsensitive abc string with A string" {
                        "abc" |> String.startsWithCapsInsensitive "A" |> equals true "returns true"
                    }

                    test "restString of null string" { null |> String.restString |> equals "" "returns empty string" }

                    test "restString of empty string" { "" |> String.restString |> equals "" "returns empty string" }

                    test "restString of a string" { "a" |> String.restString |> equals "" "returns empty string" }

                    test "restString of abc string" { "abc" |> String.restString |> equals "bc" "returns bc string" }


                    test "replacing a string with only numbers with empty returns empty" {
                        let act = "9798797" |> String.replaceNumbers ""
    ...
    module PathTests =
        ...
        let tests =
            testList
                "Path"
                [
                    test "normalize converts path separators correctly" { Path.Tests.testNormalize () }

                    test "combineWith combines and resolves paths correctly" { Path.Tests.testCombineWith () }
                ]
        ...
        let tests =
            ...
            testList
                ...
                [
                    ...
                    testPropertyWithConfig config "any valid string double can be parsed to a double"
                    <| fun (a: Double) ->
                        if a |> Double.isValid |> not then
                            true
                        else
                            a |> string |> Double.parse |> string |> ((=) (string a))

                    testPropertyWithConfig config "any string can be used to try parse"
                    <| fun s -> s |> Double.tryParse |> (fun _ -> true)

                    testPropertyWithConfig config "getPrecision can be calculated for any valid double"
                    <| fun (a: Double) n ->
                        if a |> Double.isValid |> not then
                            true
                        else
                            a |> Double.getPrecision n |> (fun _ -> true)

                    testPropertyWithConfig
                        config
                        "getPrecision for a abs value < 0 never returns a smaller value than precision (> 0)"
                    <| fun (a: Double) n ->
                        if n <= 0 || a |> Double.isValid |> not then
                            true
                        else
                            a
                    ...
                    testPropertyWithConfig config "getPrecision for every precision < 0 returns same as n = 0"
                    <| fun (a: Double) n ->
                        if a |> Double.isValid |> not then
                            true
                        else
                            a
                            |> Double.getPrecision n
                            |> (fun x -> if n < 0 then x = (a |> Double.getPrecision 0) else true)

                    // * 66.666 |> Double.getPrecision 1 = 0
                    test "66.666 |> Double.getPrecision 1 = 0" { 66.666 |> Double.getPrecision 1 |> equals 0 "" }

                    // * 6.6666 |> Double.getPrecision 1 = 0
                    test "6.6666 |> Double.getPrecision 1 = 0" { 6.6666 |> Double.getPrecision 1 |> equals 0 "" }

                    // * 0.6666 |> Double.getPrecision 1 = 1
                    test "6.6666 |> Double.getPrecision 1 = 1" { 0.6666 |> Double.getPrecision 1 |> equals 1 "" }

                    // * 0.0666 |> Double.getPrecision 1 = 2
                    test "0.0666 |> Double.getPrecision 1 = 2" { 0.0666 |> Double.getPrecision 1 |> equals 2 "" }

                    // * 0.0666 |> Double.getPrecision 0 = 0
                    test "0.0666 |> Double.getPrecision 0 = 0" { 0.0666 |> Double.getPrecision 0 |> equals 0 "" }

                    // * 0.0666 |> Double.getPrecision 2 = 3
                    test "0.0666 |> Double.getPrecision 2 = 3" { 0.0666 |> Double.getPrecision 2 |> equals 3 "" }

                    // * 0.0666 |> Double.getPrecision 3 = 4
                    test "0.0666 |> Double.getPrecision 3 = 4" { 0.0666 |> Double.getPrecision 3 |> equals 4 "" }

                    // * 6.6666 |> Double.getPrecision 0 = 0
                    test "6.6666 |> Double.getPrecision 0 = 0" { 6.6666 |> Double.getPrecision 0 |> equals 0 "" }

                    // * 6.6666 |> Double.getPrecision 2 = 1
                    test "6.6666 |> Double.getPrecision 2 = 1" { 6.6666 |> Double.getPrecision 2 |> equals 1 "" }

                    // * 6.6666 |> Double.getPrecision 3 = 2
                    test "6.6666 |> Double.getPrecision 3 = 2" { 6.6666 |> Double.getPrecision 3 |> equals 2 "" }


                    // * 66.666 |> Double.fixPrecision 1 = 67
                    test "66.666 |> Double.fixPrecision 1 = 67" { 66.666 |> Double.fixPrecision 1 |> equals 67. "" }

                    // * 6.6666 |> Double.fixPrecision 1 = 7
                    test "6.6666 |> Double.fixPrecision 1 = 7" { 6.6666 |> Double.fixPrecision 1 |> equals 7. "" }

                    // * 0.6666 |> Double.fixPrecision 1 = 0.7
                    test "6.6666 |> Double.fixPrecision 1 = 0.7" { 0.6666 |> Double.fixPrecision 1 |> equals 0.7 "" }

                    // * 0.0666 |> Double.fixPrecision 1 = 0.07
                    test "0.0666 |> Double.fixPrecision 1 = 0.07" { 0.0666 |> Double.fixPrecision 1 |> equals 0.07 "" }

                    // * 0.0666 |> Double.fixPrecision 0 = 0
                    test "0.0666 |> Double.fixPrecision 0 = 0" { 0.0666 |> Double.fixPrecision 0 |> equals 0. "" }

                    // * 0.0666 |> Double.fixPrecision 2 = 0.067
                    test "0.0666 |> Double.fixPrecision 2 = 0.067" {
                        0.0666 |> Double.fixPrecision 2 |> equals 0.067 ""
                    }

                    // * 0.0666 |> Double.fixPrecision 3 = 0.0666
                    test "0.0666 |> Double.fixPrecision 3 = 0.0666" {
                        0.0666 |> Double.fixPrecision 3 |> equals 0.0666 ""
                    }

                    // * 6.6666 |> Double.fixPrecision 0 = 7
                    test "6.6666 |> Double.fixPrecision 0 = 7" { 6.6666 |> Double.fixPrecision 0 |> equals 7. "" }

                    // * 6.6666 |> Double.fixPrecision 2 = 6.7
                    test "6.6666 |> Double.fixPrecision 2 = 6.7" { 6.6666 |> Double.fixPrecision 2 |> equals 6.7 "" }

                    // * 6.6666 |> Double.fixPrecision 3 = 6.67
                    test "6.6666 |> Double.fixPrecision 3 = 6.67" { 6.6666 |> Double.fixPrecision 3 |> equals 6.67 "" }

                    testPropertyWithConfig config "for any valid float, this float can be converted to a fraction"
                    <| fun f ->
                        if f |> Double.isValid |> not then
                            true
                        else
                            f
                            |> Double.floatToFract
    ...
    module BigRational =
        ...
        let testCalcCartesian () =
            ...
            testList
                ...
                [
                    // Test empty arrays
                    testCase "calcCartesian with empty vs1 returns empty array"
                    <| fun _ ->
                        let vs1: BigRational[] = [||]
                        let vs2 = [| 1N; 2N; 3N |]
                    ...
                    testCase "calcCartesian with empty vs2 returns empty array"
                    <| fun _ ->
                        let vs1 = [| 1N; 2N |]
                        let vs2: BigRational[] = [||]
                        let result = BigRational.calcCartesian (+) vs1 vs2
                    ...
                    testCase "calcCartesian single element vs1 addition"
                    <| fun _ ->
                        let vs1 = [| 2N |]
                        let vs2 = [| 1N; 3N; 5N |]
                        let result = BigRational.calcCartesian (+) vs1 vs2
                    ...
                    testCase "calcCartesian single element vs2 addition"
                    <| fun _ ->
                        let vs1 = [| 1N; 2N; 4N |]
                        let vs2 = [| 3N |]
                        let result = BigRational.calcCartesian (+) vs1 vs2
                    ...
                    // Test addition
                    testCase "calcCartesian addition"
                    <| fun _ ->
                        let vs1 = [| 1N; 2N |]
                        let vs2 = [| 3N; 4N |]
                        let result = BigRational.calcCartesian (+) vs1 vs2
                    ...
                    testCase "calcCartesian subtraction"
                    <| fun _ ->
                        let vs1 = [| 5N; 7N |]
                        let vs2 = [| 2N; 3N |]
                        let result = BigRational.calcCartesian (-) vs1 vs2
                    ...
                    testCase "calcCartesian multiplication"
                    <| fun _ ->
                        let vs1 = [| 2N; 3N |]
                        let vs2 = [| 4N; 5N |]
                        let result = BigRational.calcCartesian (*) vs1 vs2
                    ...
                    testCase "calcCartesian multiplication with zero"
                    <| fun _ ->
                        let vs1 = [| 0N; 2N |]
                        let vs2 = [| 3N; 4N |]
                        let result = BigRational.calcCartesian (*) vs1 vs2
                    ...
                    testCase "calcCartesian multiplication with zero in vs2"
                    <| fun _ ->
                        let vs1 = [| 2N; 3N |]
                        let vs2 = [| 0N; 4N |]
                        let result = BigRational.calcCartesian (*) vs1 vs2
                    ...
                    testCase "calcCartesian division"
                    <| fun _ ->
                        let vs1 = [| 6N; 8N |]
                        let vs2 = [| 2N; 4N |]
                        let result = BigRational.calcCartesian (/) vs1 vs2
                    ...
                    testCase "calcCartesian with fractions addition"
                    <| fun _ ->
                        let vs1 = [| 1N / 2N; 3N / 4N |]
                        let vs2 = [| 1N / 3N; 2N / 5N |]
                        let result = BigRational.calcCartesian (+) vs1 vs2
                        ...
                        Expect.equal
                            result
                            [| 5N / 6N; 9N / 10N; 13N / 12N; 23N / 20N |]
                            "Addition with fractions result should match"

                    testCase "calcCartesian with fractions multiplication"
                    <| fun _ ->
                        let vs1 = [| 1N / 2N; 2N / 3N |]
                        let vs2 = [| 3N / 4N; 4N / 5N |]
                        let result = BigRational.calcCartesian (*) vs1 vs2
                        ...
                        Expect.equal
                            result
                            [| 3N / 8N; 2N / 5N; 1N / 2N; 8N / 15N |]
                            "Multiplication with fractions result should match"

                    testCase "calcCartesian larger arrays"
                    <| fun _ ->
                        let vs1 = [| 1N; 2N; 3N |]
                        let vs2 = [| 10N; 20N |]
                        let result = BigRational.calcCartesian (+) vs1 vs2
                        ...
                        Expect.equal
                            result
                            [| 11N; 21N; 12N; 22N; 13N; 23N |]
                            "Larger arrays addition result should match"

                        Expect.equal result.Length 6 "Result length should be 6"

                    testCase "calcCartesian single element broadcasting with zero for multiplication"
                    <| fun _ ->
                        let vs1 = [| 0N |]
                        ...
                        Expect.equal
                            result
                            [| 0N; 0N; 0N; 0N; 0N |]
                            "Single element broadcasting with zero result should match"

                    testCase "calcCartesian division by single element"
                    <| fun _ ->
                        let vs1 = [| 6N; 9N; 12N |]
                        let vs2 = [| 3N |]
                        let result = BigRational.calcCartesian (/) vs1 vs2
                    ...
                    testCase "calcCartesian result ordering (Cartesian product order)"
                    <| fun _ ->
                        let vs1 = [| 1N; 2N |]
                        let vs2 = [| 10N; 20N; 30N |]
                        let result = BigRational.calcCartesian (+) vs1 vs2
        ...
        let tests =
            ...
            testList
                ...
                [
                    ...
                    test "can parse a string number 1" { "1" |> BigRational.tryParse |> equals (Some 1N) "to a br 1" }

                    testPropertyWithConfig config "can try to convert any double to bigrational"
                    <| fun (a: float) ->
                        a
                        |> (BigRational.fromFloat >> Option.defaultValue 0N >> BigRational.toFloat)
                        |> (fun b ->
                            if b = 0. || Accuracy.areClose Accuracy.veryHigh a b then
                                true
                            else
                                printfn $"%f{a} <> %f{b}"
                                false
                    ...
                    testPropertyWithConfig config "can convert any bigrational to a double"
                    <| fun br ->
                        let f = br |> BigRational.toFloat
                        ...
                        |> (fun r ->
                            if r |> Option.isNone then
                                ...
                                r |> Option.get |> BigRational.toFloat |> Accuracy.areClose Accuracy.veryHigh f
                        )

                    testPropertyWithConfig config "can parse any string float"
                    <| fun (a: float) ->
                        match
                            a
                            |> (BigRational.fromFloat
                        ...
                        with
                        | Some b -> b |> BigRational.toString |> BigRational.parse = b
                        | None -> true

                    testPropertyWithConfig config "parse can be reversed"
                    <| fun a ->
                        match a |> BigRational.tryParse with
                        | Some b -> b |> BigRational.toString |> BigRational.parse = b
                        | None -> true

                    testPropertyWithConfig config "when a is gcd of b and c then b and c both are a multiple of a"
                    <| fun b c ->
                        if (b = 0N || c = 0N) then
                            true
                        else
                    ...
                    testPropertyWithConfig config "when b is converted to multiple of c then result a is multiple of c"
                    <| fun b c ->
                        if (b = 0N || c = 0N) then
                            true
                        else
                    ...
                    testPropertyWithConfig config "can check is multiple for any bigrational"
                    <| fun b c ->
                        if c = 0N then
                            b |> BigRational.isMultiple c |> not
                        else if b |> BigRational.isMultiple c then
                            (b / c).Denominator = 1I
                        else
                            (b / c).Denominator <> 1I

                    test "when operator is multiplication" { Expect.equal ((*) |> BigRational.opIsMult) true "" }

                    test "when operator is addition" { Expect.equal ((+) |> BigRational.opIsAdd) true "" }

                    test "when operator is division" { Expect.equal ((/) |> BigRational.opIsDiv) true "" }
            ...
            testList
                ...
                [
                    ...
                    test "replace an element in an empty list " {
                        [] |> List.replace ((=) "a") "" |> equals [] "returns an empty list"
                    }
                    ...
                    test "rotations on empty list returns a list with empty list" {
                        [] |> List.rotations |> Expect.equal "should be [ [] ]" [ [] ]
                    }

                    test "rotations on single-element list returns itself" {
                        [ 42 ] |> List.rotations |> Expect.equal "should be [[42]]" [ [ 42 ] ]
                    }
    ...
    module Reflection =
        ...
        let tests =
            ...
            testList
                "Reflection toString and fromString "
                [

                    testCase "of discriminate union TestUnion"
                    <| fun _ -> Expect.equal (TestUnion |> Reflection.toString) "TestUnion" "should print TestUnion"

                    test "of discriminate union AnotherTestUnion" {
                        Expect.equal
                            (AnotherTestUnion |> Reflection.toString)
                            "AnotherTestUnion"
                            "should print AnotherTestUnion"
                    }

                    test "can create a TestUnion Option" {
                        Expect.equal
                            ("TestUnion" |> Reflection.fromString<TestUnion>)
                            (Some TestUnion)
                            "from string TestUnion"
                    }
    ...
    module Csv =
        ...
        let inline parse<'T> dt (p: string -> 'T option) (s: string) = s |> Csv.parse false dt p |> unbox<'T>
        ...
        let parserTests =
            testList
                "parse"
                [
                    test "string" { "a string" |> parseString |> Expect.equal "should be equal to" "a string" }

                    fun (s1: string) -> s1 |> parseString |> (fun s2 -> s2 = s1)
                    |> Generators.testProp "any string"

                    test "string with trailing spaces" {
                        "trailing "
                        |> parseString
                        |> fun s1 -> Swensen.Unquote.Assertions.test <@ s1 = "trailing " @>
                    }
            ...
            testList
                ...
                [
                    test "trailing spaces " {
                        ...
                        |> fun r -> Swensen.Unquote.Assertions.test <@ r = "trailing spaces" @>
                    }

                    test "without option fails" {
                        try
                            "cannot cast to integer" |> Csv.tryCast<int> Csv.Int32Data |> ignore
                    ...
                    fun x ->
                        x |> Csv.tryCast<int option> Csv.Int32OptionData |> ignore
                        true
                    |> Generators.testProp "with int option never fails"

                    fun x ->
                        x |> Csv.tryCast<double option> Csv.FloatOptionData |> ignore
                        true
                    |> Generators.testProp "with double option never fails"

                    fun x ->
                        x |> Csv.tryCast<decimal option> Csv.DecimalOptionData |> ignore
                        true
            ...
            testList
                ...
                [
                    test "can parse csv formatted string" {
                        testCsv |> Csv.parseCSV |> Ok |> Expect.isOk "should be ok"
                    }
        ...
        let propertyTests =
            ...
            testList
                ...
                [
                    ...
                    testProperty "capacity is always preserved"
                    <| fun (PositiveInt capacity) ->
                        (capacity > 0 && capacity < 1000)
                        ==> lazy
                            (let rb = RingBuffer.create capacity
                             rb.Capacity = capacity)

                    testProperty "count never exceeds capacity"
                    <| fun (PositiveInt capacity) (items: int list) ->
                    ...
                    testProperty "toArray length equals count"
                    <| fun (PositiveInt capacity) (items: int list) ->
                        (capacity > 0 && capacity < 100)
                        ==> lazy
                            (let rb = RingBuffer.create capacity
                    ...
                    testProperty "map preserves count and order"
                    <| fun (PositiveInt capacity) (items: int list) ->
                        (capacity > 0 && capacity < 100)
                        ==> lazy
                            (let rb = RingBuffer.create capacity
                    ...
                    testProperty "toSeq and toArray are equivalent"
                    <| fun (PositiveInt capacity) (items: int list) ->
                        (capacity > 0 && capacity < 100)
                        ==> lazy
                            (let rb = RingBuffer.create capacity
                    ...
                    testProperty "clear always resets to empty state"
                    <| fun (PositiveInt capacity) (items: int list) ->
                        (capacity > 0 && capacity < 100 && items |> List.length < 200)
                        ==> lazy
                            (let rb = RingBuffer.create capacity
                             items |> List.iter (fun item -> RingBuffer.add item rb)
                             ...
                             rb.CountValue = 0 && not rb.IsFull && (RingBuffer.toArray rb).Length = 0)


                    testProperty "adding items maintains newest-first property when full"
                    <| fun (capacity: int) ->
                        (capacity > 0 && capacity <= 100)
                        ==> lazy
                            (let rb = RingBuffer.create capacity
                             ...
                             if not (items = expected) then
                                 printfn $"{capacity} -> items: {items}, expected: {expected}"
