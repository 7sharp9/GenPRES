...
module Tests =
    ...
    module AgentLogging =
        ...
        let createErrorMessage error code =
            {
                Error = error
                Code = code
            }
                ...
                [
                    ...
                    test "create should use correct formatter for message type" {
                        ...
                        Expect.stringContains
                            unknownResult
                            "cannot format"
                            "Unknown message should contain cannot format"
                    }
        ...
        let discriminatedUnionFormatterTests =
            testList
                "Discriminated Union Message Formatters"
                [

                    test "should format discriminated union with simple cases" {
                        let formatters =
                            [
                                typeof<LogEventMessage>,
                                (fun (msg: IMessage) ->
                        ...
                        Expect.equal
                            errorResult
                            "ERROR[2001]: Connection failed - Network timeout"
                    ...
                    test "should format nested discriminated unions" {
                        ...
                        Expect.equal
                            ...
                            "Startup message should be formatted correctly"

                        Expect.equal
                            configResult
                            "CONFIG: WARN[3001]: Invalid setting"
                            "Nested discriminated union should be formatted correctly"
                    }
                    ...
                    test "should handle complex discriminated unions with multiple types" {
                        ...
                        let formatters =
                            [
                                ...
                                (fun (msg: IMessage) ->
                                    ...
                                    | Compound(logEvent, sysMsg) ->
                                        $"COMPOUND: {formatLogEvent logEvent} | {formatSystemMessage sysMsg}"
                                )
                            ]
                        ...
                        let compoundResult =
                            formatter (Compound(ErrorEvent("Failed", 500, "Details"), StartupMessage "2.0") :> IMessage)
                        ...
                        Expect.equal
                            compoundResult
                            "COMPOUND: ERROR[500]: Failed - Details | STARTUP: Version 2.0"
                            "Compound case should be formatted correctly"
                    }
                    ...
                    test "should handle inheritance-like behavior with interfaces" {
                        ...
                        Expect.equal
                            anotherDerivedResult
                            "BASE: Error occurred (Code: 404)"
                            "Another derived message should use base formatter"
                    }
                    ...
                    test "should use first matching formatter in list order" {
                        ...
                        Expect.equal
                            derivedResult
                            "BASE: Test message"
                            "First matching formatter should be used for DerivedMessage"

                        Expect.equal
                            anotherDerivedResult
                            "BASE: Error occurred (Code: 404)"
                            "Base formatter should be used for AnotherDerivedMessage"
                    }
                    ...
                    test "should prioritize more specific formatters when listed first" {
                        ...
                        Expect.equal
                            derivedResult
                            "DERIVED: Test message"
                            "More specific formatter should be used when listed first"

                        Expect.equal
                            anotherDerivedResult
                            "BASE: Error occurred (Code: 404)"
                            "Base formatter should be used for non-derived types"
                    }
                    ...
                    test "should handle multiple formatters for same discriminated union type" {
                        ...
                        let errorResult =
                            formatter (ErrorEvent("Database error", 5001, "Connection timeout") :> IMessage)
                        ...
                        Expect.equal
                            errorResult
                            "❌ [5001] Database error: Connection timeout"
                            "Error with emoji formatter should work"
                    }
                    ...
                    test "should handle fallback for unregistered discriminated union types" {
                        ...
                        Expect.equal
                            knownResult
                            "LOG: Known message"
                            "Known discriminated union should use specific formatter"

                        Expect.equal
                            unknownResult
                            "UNKNOWN: StartupMessage"
                            "Unknown discriminated union should use fallback"
                    }
